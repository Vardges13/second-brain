...
- Время до первой ценности`,tags:["стратегия","ии","технологии"]}],a=[{id:"landing-ai-company",title:"Лендинг ИИ-компании",description:"Создать посадочную страницу для ИИ-компании с современным дизайном",status:"in-progress",priority:"high",createdAt:"2026-02-13"},{id:"company-name",title:"Название компании",description:"Придумать и зарегистрировать название для ИИ-компании",status:"todo",priority:"high",createdAt:"2026-02-12"},{id:"travel-agency-case",title:"Кейс турагентство",description:"Написать кейс-стади для проекта автоматизации турагентства",status:"backlog",priority:"medium",createdAt:"2026-02-10"},{id:"market-research",title:"Исследование рынка",description:"Провести анализ конкурентов в сфере ИИ-решений",status:"done",priority:"medium",createdAt:"2026-02-05",completedAt:"2026-02-11"},{id:"tech-stack-selection",title:"Выбор технологий",description:"Определить технический стек для разработки MVP",status:"done",priority:"high",createdAt:"2026-02-01",completedAt:"2026-02-08"}];function i(e){let i=e.toLowerCase(),l=t.filter(e=>e.title.toLowerCase().includes(i)||e.content.toLowerCase().includes(i)||e.tags?.some(e=>e.toLowerCase().includes(i)));return{memories:l,documents:s.filter(e=>e.title.toLowerCase().includes(i)||e.content.toLowerCase().includes(i)||e.tags?.some(e=>e.toLowerCase().includes(i))),tasks:a.filter(e=>e.title.toLowerCase().includes(i)||e.description?.toLowerCase().includes(i))}}e.s(["sampleDocuments",0,s,"sampleMemories",0,t,"sampleTasks",0,a,"searchContent",()=>i])},87316,e=>{"use strict";let t=(0,e.i(75254).default)("calendar",[["path",{d:"M8 2v4",key:"1cmpym"}],["path",{d:"M16 2v4",key:"4m81vk"}],["rect",{width:"18",height:"18",x:"3",y:"4",rx:"2",key:"1hopcy"}],["path",{d:"M3 10h18",key:"8toen8"}]]);e.s(["Calendar",()=>t],87316)},4555,e=>{"use strict";var t=e.i(43476),s=e.i(71645),a=e.i(55711),i=e.i(55436),l=e.i(87316),c=e.i(51975),r=e.i(18789),n=e.i(16148);function d(){let[e,d]=(0,s.useState)(""),[o,m]=(0,s.useState)(null),x=n.sampleMemories.filter(t=>t.title.toLowerCase().includes(e.toLowerCase())||t.content.toLowerCase().includes(e.toLowerCase())||t.tags?.some(t=>t.toLowerCase().includes(e.toLowerCase()))).sort((e,t)=>new Date(t.date).getTime()-new Date(e.date).getTime()),h=e=>new Date(e).toLocaleDateString("ru-RU",{weekday:"long",year:"numeric",month:"long",day:"numeric"});return(0,t.jsxs)("div",{className:"space-y-6",children:[(0,t.jsxs)("div",{className:"flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0",children:[(0,t.jsxs)("div",{className:"flex items-center space-x-3",children:[(0,t.jsx)(a.Brain,{className:"h-8 w-8 text-blue-400"}),(0,t.jsx)("h1",{className:"text-3xl font-bold text-white",children:"Память"})]}),(0,t.jsxs)("div",{className:"relative",children:[(0,t.jsx)(i.Search,{className:"h-5 w-5 text-gray-400 absolute left-3 top-1/2 transform -translate-y-1/2"}),(0,t.jsx)("input",{type:"text",placeholder:"Поиск по записям...",value:e,onChange:e=>d(e.target.value),className:"input-field pl-10 w-full sm:w-80"})]})]}),(0,t.jsxs)("div",{className:"grid grid-cols-1 lg:grid-cols-3 gap-8",children:[(0,t.jsx)("div",{className:"lg:col-span-1 space-y-4",children:(0,t.jsxs)("div",{className:"card",children:[(0,t.jsxs)("h2",{className:"text-lg font-semibold text-white mb-4",children:["Записи (",x.length,")"]}),(0,t.jsxs)("div",{className:"space-y-3 max-h-[calc(100vh-300px)] overflow-y-auto",children:[x.map(e=>(0,t.jsxs)("div",{onClick:()=>m(e),className:`p-4 rounded-lg cursor-pointer transition-colors ${o?.id===e.id?"bg-blue-900/30 border border-blue-500":"bg-gray-800 hover:bg-gray-700"}`,children:[(0,t.jsxs)("div",{className:"flex items-start justify-between mb-2",children:[(0,t.jsx)("h3",{className:"font-medium text-white text-sm line-clamp-2",children:e.title}),(0,t.jsx)(l.Calendar,{className:"h-4 w-4 text-gray-400 flex-shrink-0 ml-2"})]}),(0,t.jsx)("p",{className:"text-xs text-gray-400 mb-2",children:h(e.date)}),(0,t.jsxs)("p",{className:"text-sm text-gray-300 line-clamp-3",children:[e.content.replace(/#{1,6}\s+/g,"").substring(0,150),"..."]}),e.tags&&e.tags.length>0&&(0,t.jsxs)("div",{className:"flex flex-wrap gap-1 mt-3",children:[e.tags.slice(0,3).map(e=>(0,t.jsx)("span",{className:"badge bg-blue-900 text-blue-200 text-xs",children:e},e)),e.tags.length>3&&(0,t.jsxs)("span",{className:"text-xs text-gray-400",children:["+",e.tags.length-3]})]})]},e.id)),0===x.length&&(0,t.jsxs)("div",{className:"text-center py-8 text-gray-400",children:[(0,t.jsx)(a.Brain,{className:"h-12 w-12 mx-auto mb-4 opacity-50"}),(0,t.jsx)("p",{children:"Записи не найдены"}),e&&(0,t.jsx)("p",{className:"text-sm mt-2",children:"Попробуйте изменить поисковый запрос"})]})]})]})}),(0,t.jsx)("div",{className:"lg:col-span-2",children:o?(0,t.jsxs)("div",{className:"card",children:[(0,t.jsxs)("div",{className:"border-b border-gray-700 pb-4 mb-6",children:[(0,t.jsx)("div",{className:"flex items-start justify-between mb-3",children:(0,t.jsx)("h1",{className:"text-2xl font-bold text-white",children:o.title})}),(0,t.jsxs)("div",{className:"flex items-center space-x-4 text-sm text-gray-400",children:[(0,t.jsxs)("div",{className:"flex items-center space-x-1",children:[(0,t.jsx)(l.Calendar,{className:"h-4 w-4"}),(0,t.jsx)("span",{children:h(o.date)})]}),o.tags&&o.tags.length>0&&(0,t.jsxs)("div",{className:"flex items-center space-x-1",children:[(0,t.jsx)(c.Tag,{className:"h-4 w-4"}),(0,t.jsx)("div",{className:"flex space-x-1",children:o.tags.map(e=>(0,t.jsx)("span",{className:"badge bg-blue-900 text-blue-200",children:e},e))})]})]})]}),(0,t.jsx)("div",{className:"prose-dark",children:(0,t.jsx)(r.default,{children:o.content})})]}):(0,t.jsx)("div",{className:"card",children:(0,t.jsxs)("div",{className:"text-center py-12",children:[(0,t.jsx)(a.Brain,{className:"h-16 w-16 mx-auto mb-6 text-gray-600"}),(0,t.jsx)("h2",{className:"text-xl font-semibold text-gray-400 mb-2",children:"Выберите запись для просмотра"}),(0,t.jsx)("p",{className:"text-gray-500",children:"Кликните на любую запись из списка слева, чтобы посмотреть её содержимое"})]})})})]})]})}e.s(["default",()=>d])}]);